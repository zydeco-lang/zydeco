...
//             | Value::Var(def) => match lo.stack.globals.get(&def) {
...
//                 // compile the kontinuation into a labelled program,
//                 // and then push the label and pack the context onto the stack
//                 todo!()
//             }
//             | Stack::Var(sk::Bullet) => kont(lo),
//             | Stack::Arg(Cons(value, tail)) => {
//                 // compile the tail, then push the value onto the stack
//                 tail.lower(
//                     lo,
//                     Box::new(move |lo| {
//                         value.lower(lo, Box::new(move |arg, lo| lo.instr(Push(arg), kont)))
//                     }),
//                 )
//             }
//             | Stack::Tag(Cons(dtor, tail)) => todo!(),
//         }
//     }
// }
