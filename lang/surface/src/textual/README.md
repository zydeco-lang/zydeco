...
- `parser` is generated by LALRPOP from `parser.lalrpop` and remains private to the textual module.
  It consumes tokens and builds the textual AST by calling into the arena-allocating `Parser`.
