...
// mod impl_syntax {
//     use super::super::new_syntax as new;
//     use super::super::syntax as old;
//     impl From<old::Program> for new::Module {
//         fn from(p: old::Program) -> Self {
//             let mut decls: Vec<_> = p.decls.into_iter().map(Into::into).collect();
//             decls.push(new::Declaration {
//                 public: false,
//                 external: false,
//                 decl: new::Declare::Entry(p.comp.into()),
//             });
//             Self {
//                 name: None,
//                 decls,
...
//     impl From<old::Declare> for new::Declaration {
//         fn from(decl: old::Declare) -> Self {
//             match decl {
//                 old::Declare::Data(d) => Self {
//                     public: true,
//                     external: false,
//                     decl: new::Declare::Data(d.into()),
//                 },
//                 old::Declare::Codata(d) => Self {
//                     public: true,
//                     external: false,
//                     decl: new::Declare::Codata(d.into()),
//                 },
//                 old::Declare::Define{
//                     public,
//                     name,
...
//                     public,
//                     external: false,
//                     decl: new::Declare::Define(ann.make(new::Define {
//                         name: name.into(),
//                         ty: ty.into(),
//                         def: def.into(),
//                     })),
