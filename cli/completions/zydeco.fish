...
complete -c zydeco -n "__fish_zydeco_needs_command" -f -a "repl" -d 'Start a REPL'
...
complete -c zydeco -n "__fish_zydeco_using_subcommand repl" -s v -l verbose -d 'Level of verbosity'
complete -c zydeco -n "__fish_zydeco_using_subcommand repl" -s h -l help -d 'Print help'
complete -c zydeco -n "__fish_zydeco_using_subcommand help; and not __fish_seen_subcommand_from run check repl help" -f -a "run" -d 'Run a zydeco program'
complete -c zydeco -n "__fish_zydeco_using_subcommand help; and not __fish_seen_subcommand_from run check repl help" -f -a "check" -d 'Check a zydeco program'
complete -c zydeco -n "__fish_zydeco_using_subcommand help; and not __fish_seen_subcommand_from run check repl help" -f -a "repl" -d 'Start a REPL'
complete -c zydeco -n "__fish_zydeco_using_subcommand help; and not __fish_seen_subcommand_from run check repl help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
