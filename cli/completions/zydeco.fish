...
complete -c zydeco -n "__fish_zydeco_using_subcommand help; and not __fish_seen_subcommand_from show passes fmt run check test repl build help" -f -a "show" -d 'List the project\'s packages and relationships without checking or executing code'
complete -c zydeco -n "__fish_zydeco_using_subcommand help; and not __fish_seen_subcommand_from show passes fmt run check test repl build help" -f -a "passes" -d 'List optional compiler passes or explain a selected high-SPS plan'
complete -c zydeco -n "__fish_zydeco_using_subcommand help; and not __fish_seen_subcommand_from show passes fmt run check test repl build help" -f -a "fmt" -d 'Format Zydeco source files in place'
complete -c zydeco -n "__fish_zydeco_using_subcommand help; and not __fish_seen_subcommand_from show passes fmt run check test repl build help" -f -a "run" -d 'Run a zydeco program'
complete -c zydeco -n "__fish_zydeco_using_subcommand help; and not __fish_seen_subcommand_from show passes fmt run check test repl build help" -f -a "check" -d 'Check a source package and its code dependencies, including its declared executable role'
complete -c zydeco -n "__fish_zydeco_using_subcommand help; and not __fish_seen_subcommand_from show passes fmt run check test repl build help" -f -a "test" -d 'Run explicitly selected test packages with empty stdin'
complete -c zydeco -n "__fish_zydeco_using_subcommand help; and not __fish_seen_subcommand_from show passes fmt run check test repl build help" -f -a "repl" -d 'Start the declaration-free terminal REPL'
complete -c zydeco -n "__fish_zydeco_using_subcommand help; and not __fish_seen_subcommand_from show passes fmt run check test repl build help" -f -a "build" -d 'Build a Zydeco program for the selected target'
complete -c zydeco -n "__fish_zydeco_using_subcommand help; and not __fish_seen_subcommand_from show passes fmt run check test repl build help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
