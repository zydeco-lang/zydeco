# Computation witness routes

Extend computation application beyond its leading existential prefix only
with an explicit witness route through preceding products.
Preserve identity and non-escape checks;
