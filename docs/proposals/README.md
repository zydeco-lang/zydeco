...
| [Memory layouts and views](memory.md) | Static/dynamic views, typed field paths, fixed arrays, and partial initialization | [Manual memory](../references/language.md#manual-memory) |
