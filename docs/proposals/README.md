...
| [Documentation](documentation.md) | Presentation, published anchors, independent verification, standard-library coverage, and later authoring/client extensions | [Subjects](../references/compiler.md#documentation-subjects-and-provenance) and [example verification](../references/compiler.md#verifying-documentation-examples) |
