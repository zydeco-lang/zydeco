...
| [Traversals](traversals.md) | Further diagnostic recovery, graph adapters, synthesized results, and independent pruning | [Traversal selection and composition](../references/compiler.md#choosing-and-composing-traversals) and [diagnostic collection](../references/compiler.md#diagnostic-collection) |
