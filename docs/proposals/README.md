...
| [Memory boundaries](memory.md) | Additional target facts, stack/arena release, and managed-reference storage | [Layouts, fields, arrays, and views](../references/language.md#manual-memory) |
