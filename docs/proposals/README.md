...
| [Zydeco ABI](zydeco-abi.md) | Nominal and dependent unit interfaces, shared initialization, host bindings, and remaining workload | [Native units](../references/language.md#native-zydeco-units) and [unit artifacts](../references/compiler.md#native-unit-artifacts) |
