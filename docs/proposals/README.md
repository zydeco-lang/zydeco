...
| [Manual memory](memory.md) | Partial initialization, typed field paths, generic element builders, and additional storage boundaries | [Manual memory](../references/language.md#manual-memory) |
