...
| [Completion](completion.md) | Structural candidates, snippets, and optional last-successful revision state | [Recovery](../references/compiler.md#recovering-parsing) and [completion](../references/compiler.md#completion) |
| [Source Packages](package-management.md) | Frontend integration, semantic-unit analysis, compilation-unit validation, and relationship policy | [Abstraction levels](../references/language.md#abstraction-levels), [source packages](../references/language.md#source-packages), and [implementation representations](../references/compiler.md#implementation-representations) |
| [Documentation](documentation.md) | Reconsider subjects, provenance, selection, verification, and presentation before implementation | [`@[doc]` text attachment](../references/language.md#source-documentation) |
